...
private val IrFunction.needsInlining get() = (this.isInline || (this as? IrSimpleFunction)?.isOperator ?: false) && !this.isExternal
  ...
  private inner class ParameterSubstitutor : IrElementTransformerVoid() {
    ...
    override fun visitCall(expression: IrCall): IrExpression {
      ...
      if (functionArgument is IrFunctionReference) {
        ...
        return visitExpression(super.visitExpression(immediateCall))
      }
...
fun IrElementTransformerVoidWithContext.inline(
  ...
  val actualCallee = DefaultInlineFunctionResolver(context).getFunctionDeclaration(callee.symbol)
