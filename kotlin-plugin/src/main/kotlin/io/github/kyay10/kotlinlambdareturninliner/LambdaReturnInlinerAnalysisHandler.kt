...
class LambdaReturnInlinerAnalysisHandler(
  ...
  override fun doAnalysis(
    ...
    if (AnalysisHandlerExtension.getInstances(project)
        .filterIsInstance<AbstractKapt3Extension>()
        .any { it.options.mode != AptMode.WITH_COMPILATION }
    ) {
      // Ignore KAPT's shenanigans
      return null
    }
